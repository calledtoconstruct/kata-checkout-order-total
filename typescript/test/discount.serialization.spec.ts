...
class StandardDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountPrice":1,"tag":"StandardDiscount"}`;
        super(discount, text);
    }
}
...
class BulkFlatPriceDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":3,"discountPrice":1,"tag":"BulkFlatPriceDiscount"}`;
        super(discount, text);
    }
}
...
class UpSalePercentDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":2,"discountSale":1,"tag":"UpSalePercentDiscount","discountPercent":0.25}`;
        super(discount, text);
    }
}
...
class LimitedUpSalePercentDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":2,"discountSale":1,"tag":"LimitedUpSalePercentDiscount","discountPercent":0.25,"discountLimit":3}`;
        super(discount, text);
    }
}
...
class UpSaleFlatPriceDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":2,"discountSale":1,"tag":"UpSaleFlatPriceDiscount","discountPrice":1}`;
        super(discount, text);
    }
}
...
class LimitedUpSaleFlatPriceDiscountSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":2,"discountSale":1,"tag":"LimitedUpSaleFlatPriceDiscount","discountPrice":1,"discountLimit":3}`;
        super(discount, text);
    }
}
...
class UpSalePercentDiscountByWeightSerializationScenario extends DiscountSerializationScenario {
    constructor() {
        ...
        const text = `{"discountStartDate":"${startDateAsString}","discountEndDate":"${endDateAsString}","discountCode":"cat food","discountBulk":2,"discountSale":1,"tag":"UpSalePercentDiscountByWeight","discountPercent":1}`;
        super(discount, text);
    }
}
